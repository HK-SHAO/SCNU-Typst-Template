...
#rect(stroke: 1pt, radius: 0.5em)[
  #link(label("edge"))[#image("./imgs/zz03.png", width: 80%)] <jsonnext>]
]

#let show-edge = link(label("jsonnext"))[#image("./imgs/zz04.png", width: 100%) <edge> ]
...
#let s = (s.methods.info)(
  ...
  // date: datetime.today(),
  institution: [
    #box(baseline: 0.8em)[#image("./imgs/paper-scnu.svg", width: 40%)] #text(size: 24pt, font: heiti)[~$dot.c$~本科毕设答辩]
  ],
)
...
#[
  ...
  columns: 2,
   gutter: -0em,
  [
#image("./imgs/gpt2-fig-003.svg")
#v(-1em) (1) OpenAI/GPT-2 117M
  ],[
#image("./imgs/gpt2-large-fig-003.svg")
#v(-1em) (2) OpenAI/GPT-2 Large 774M
  ],[
#image("./imgs/gpt2-xl-fig-003.svg")
#v(-1em) (3) OpenAI/GPT-2 XL 1558M
  ],[
#image("./imgs/gemma-fig-003.svg")
...
#v(-0.5em)
#image("./imgs/C_grammar_stmt_svg.svg", width: 100%)
// #v(-0.5em)
- *左侧*：C语言的一个子集CFG表示
- *右侧*：将代码表示为CFG的推导树
...
#box(baseline: 1.5em)[#image("./imgs/fig_save3.svg", width: 50%)]~#box(width: 45%, height: 4.5em)[
